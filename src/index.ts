export {
    Diagram, DiagramType, Path, polygon, line, linea, curve, empty, text, image, multiline, multiline_bb, foreign_object, diagram_combine,
} from './diagram.js';
...
export * as shapes3d from './daigrams_library/svg_test.js'
